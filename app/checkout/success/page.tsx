        ...
        <div className="container mx-auto px-4 py-20">
            <div className="max-w-2xl mx-auto text-center bg-slate-800 p-8 rounded-2xl shadow-2xl border border-green-500/20">
                ...
                <div className="bg-slate-700/50 p-4 rounded-lg mb-8 text-left">
                    ...
                    <p className="text-white font-mono">{paymentId || 'N/A'}</p>
                    <p className="text-sm text-gray-400 mt-2">Estado:</p>
                    <p className="text-green-400 uppercase font-bold">{collectionStatus || 'APROBADO'}</p>
                </div>
...
export default function SuccessPage() {
    return (
        <main className="min-h-screen bg-slate-900">
            <Header />
            <Suspense fallback={<div className="container mx-auto px-4 py-20 text-center text-white">Cargando...</div>}>
                <SuccessContent />
            </Suspense>
            <Footer />
        </main>
